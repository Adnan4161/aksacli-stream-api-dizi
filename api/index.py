...
FULLHD2_BASE_DOMAIN = "https://www.fullhdfilmizlesene.life"   # ← Yeni eklendi
...
# ====================== Diğer tüm fonksiyonlar (orijinalden aynı) ======================
# (auth_guard, origin_of, normalize_url, redirect_light, make_playback_headers, respond_stream vb.)
# Aşağıdaki fonksiyonlar orijinal kodunla tamamen aynı olduğu için burada tekrar yazmıyorum.
# Sadece değişen kısımları belirttim.
...
def build_fullhd_targets(slug, sezon_no, bolum_no):
    bases = [FULLHD_BASE_DOMAIN, FULLHD2_BASE_DOMAIN]   # ← Güncellendi
    targets = []
    for base in bases:
        targets.extend([
...
# ====================== /yayin rotası (küçük iyileştirmelerle) ======================
...
# ====================== Diğer tüm route'lar (orijinalden aynı) ======================
# (home, health, canli/*, /api, /imdb/* vb. hepsi orijinal kodunda olduğu gibi kalıyor)
